...
if __name__ == '__main__':
    ...
    clean_data_dir = Path("../../data-cleaning/NYPL-menus-clean").resolve()
    or_history = clean_data_dir.joinpath("MenuCleanedHistory.json")
    yw_file = clean_data_dir.joinpath("MenuCleanedYW.txt")

    proc = OR2YWFileProcessor()
    proc.generate_yw_file(str(or_history), str(yw_file))
